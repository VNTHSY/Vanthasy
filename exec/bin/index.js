...
program
    .version("0.1.0-beta6")
    .description("CLI for the Overvoid Image Repository");
...
program
    ...
    .action(async () => {
        ...
        async function performSeeding() {
            try {
                const imagesIndexResponse = await axios.get(config.imagesIndex);
    ...
    .action(async () => {
        ...
        async function doesUserExist(username) {
            ...
            if (users) {
                ...
                return false; // if no users exist
            }
        }
        ...
        async function doesEmailExist(email) {
            ...
            if (users) {
                ...
                async function main() {
                    log.init('create a new *admin* user for the Overvoid panel:')
