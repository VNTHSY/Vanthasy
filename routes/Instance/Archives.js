  ...
  try {
    ...
    if (instance.Node && instance.Node.address && instance.Node.port) {
      ...
      try {
        ...
        const errorMessage =
          error.response?.data?.message || "Connection to node failed.";
...
router.post("/instance/:id/archives/create", async (req, res) => {
  ...
  const RequestData = {
    method: "post",
    // url: `http://${instance.Node.address}:${instance.Node.port}/archive/${instance.ContainerId}/archives`,
    url: `http://Overvoid:${instance.Node.apiKey}@${instance.Node.address}:${instance.Node.port}/archive/${instance.ContainerId}/archives/${instance.VolumeId}/create`,
    headers: {
      "Content-Type": "application/json",
    },
  };
...
router.post("/instance/:id/archives/delete/:archivename", async (req, res) => {
  ...
  const RequestData = {
    method: "post",
    // url: `http://${instance.Node.address}:${instance.Node.port}/archive/${instance.ContainerId}/archives`,
    url: `http://Overvoid:${instance.Node.apiKey}@${instance.Node.address}:${instance.Node.port}/archive/${instance.ContainerId}/archives/delete/${archivename}`,
    headers: {
      "Content-Type": "application/json",
    },
  };
...
router.post(
  "/instance/:id/archives/rollback/:archivename",
  async (req, res) => {
    console.log(req.body);
    const { id, archivename } = req.params;
    if (!req.user) {
    ...
    const RequestData = {
      method: "post",
      // url: `http://${instance.Node.address}:${instance.Node.port}/archive/${instance.ContainerId}/archives`,
      url: `http://Overvoid:${instance.Node.apiKey}@${instance.Node.address}:${instance.Node.port}/archive/${instance.ContainerId}/archives/rollback/${instance.VolumeId}/${archivename}`,
      headers: {
        "Content-Type": "application/json",
      },
    };
