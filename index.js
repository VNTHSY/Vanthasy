 ...
 *
 *      ___                                   _      _ 
 *     /___\__   __  ___  _ __ __   __  ___  (_)  __| |
 *   //  //\ \ / / / _ \| '__|\ \ / / / _ \ | | / _` |
 *  / \_//  \ V / |  __/| |    \ V / | (_) || || (_| |
...
/**
 * @fileoverview Main server file for Overvoid Panel. Sets up the express application,
...
app.listen(config.port, () => log.info(`Overvoid is listening on port ${config.port}`));
